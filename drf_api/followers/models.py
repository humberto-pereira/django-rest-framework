...
class Follower(models.Model):
    ...
    owner = models.ForeignKey(
        User, related_name='following', on_delete=models.CASCADE # CASCADE: if the user is deleted, delete all the followers
    )
    ...
    class Meta:
        ordering = ['-created_at']
        unique_together = ['owner', 'followed']# owner and followed together must be unique
